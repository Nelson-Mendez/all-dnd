const barbarianClass = {
  ...
  class_features: {
    ...
    "Extra Attack":
      "Beggining at 5th level, you can attack twice, instead of once, whenever you take the Attack action on your turn.",
    "Fast Movement":
      "Starting at 5th level, your speed increases by 10 feet while you aren't wearing heavy armour.",
    "Feral Instinct":
      "At 7th level, a Barbarians instincts are so honed, that you have advantage on Initiative Rolls. Additionally, if you are surprised at the beginning of combat, and aren't incapacitated, you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.",
    "Brutal Critical":
      "Beggining at the 9th level, you can roll one additional weapon damage die when determining the extra damage for a critical hit with a melee attack. This increases to two additional dice at 13th level, and three additional dice at 17th level",
    "Relentless Rage":
  ...
  Hits: {
    ...
    "Higher Levels":
      "1d12 (7) + Constitution Modifier per Barbarian level after 1st",
  },
  Proficiencies: {
  ...
  Rage: {
    Description:
      "In battle, you fight with primal ferocity. On your turn, you can enter a rage as a bonus action. While raging, you gain the following benefits if you aren't wearing heacy armour",
    Benefits: [
      "You have advantage on both Strength Checks and Strength Saving Throws",
      "When you make a melee weapon attack using Strength, you gain a bonus to the Damage Roll that increases as you gain levels as a Barbarian, as shown in the Rage Damage column of the Barbarian table",
      "You have resistance to Bludgeoning, Piercing, and Slashing damage",
    ],
    info: [
      "If you are able to cast spells, you can't cast them, or concentrate on them while raging.",
      "Your rage lasts for 1 minute. It ends early if you are knocked unconscious, or if your turn ends and either: you haven't attacked a hostile creature since your last turn, or you haven't taken damage since your last turn. You may also end your rage on your turn as a bonus action",
